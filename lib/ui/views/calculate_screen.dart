...
import 'package:moolaxblock/business_logic/view_models/calculate_screen_viewmodel.dart';
import 'package:moolaxblock/ui/views/choose_favorites.dart';

import '../../business_logic/view_models/calculate_screen_state.dart';
...
class _CalculateCurrencyScreenState extends State<CalculateCurrencyScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<CalculateScreenViewModel, CalculateScreenState>(
